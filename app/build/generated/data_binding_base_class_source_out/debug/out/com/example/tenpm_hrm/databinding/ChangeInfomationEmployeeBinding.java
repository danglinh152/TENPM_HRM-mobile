...
public final class ChangeInfomationEmployeeBinding implements ViewBinding {
  @NonNull
  ...
  private ChangeInfomationEmployeeBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ChangeInfomationEmployeeBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ChangeInfomationEmployeeBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.change_infomation_employee, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ChangeInfomationEmployeeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ChangeInfomationEmployeeBinding((ConstraintLayout) rootView, Address, Birthday,
          CCCD, Email, Name, Phone, Position, button, genderGroup, idDepartment, imageView,
          imageView10, imageView2, imageView3, imageView4, imageView5, imageView6, imageView7,
          imageView8, imageView9, main, radioFemale, radioMale, textView, textView10, textView13,
          textView14, textView15, textView2, textView4, textView5, textView6, textView7, textView8,
          textView9);
    }
