...
public final class ItemCalendarBinding implements ViewBinding {
  ...
  private ItemCalendarBinding(@NonNull ConstraintLayout rootView, @NonNull TextView itemCalendar) {
    this.rootView = rootView;
    this.itemCalendar = itemCalendar;
  }
  ...
  public static ItemCalendarBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.item_calendar;
      TextView itemCalendar = ViewBindings.findChildViewById(rootView, id);
      if (itemCalendar == null) {
        break missingId;
      }

      return new ItemCalendarBinding((ConstraintLayout) rootView, itemCalendar);
    }
