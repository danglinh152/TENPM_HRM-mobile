...
public final class CreateDepartmentAdminBinding implements ViewBinding {
  @NonNull
  ...
  private CreateDepartmentAdminBinding(@NonNull ConstraintLayout rootView, @NonNull Button button,
  ...
  @NonNull
  public static CreateDepartmentAdminBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static CreateDepartmentAdminBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.create_department_admin, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static CreateDepartmentAdminBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new CreateDepartmentAdminBinding((ConstraintLayout) rootView, button, imageView,
          imageView2, imageView3, imageView4, imageView5, imageView6, imageView7, imageView8,
          linearLayout, textView, textView2, textView3, textView4, textView5, textView6, textView8);
    }
